...
class Craguard < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/shieldmark-io/homebrew-craguard/releases/download/v0.6.5/craguard-0.6.5-darwin-arm64.tar.gz"
      sha256 "37d7ecef5b2160f5ff2bf12c26d1cfbc20b30ce0ea485a453ac61907a4ffdc7c"
    end
    if Hardware::CPU.intel?
      url "https://github.com/shieldmark-io/homebrew-craguard/releases/download/v0.6.5/craguard-0.6.5-darwin-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/shieldmark-io/homebrew-craguard/releases/download/v0.6.5/craguard-0.6.5-linux-arm64.tar.gz"
      sha256 "5cae1dc3e4ab4393e1766711a88c09a5aa5a36d370fd4d9534f6bf312a9b5385"
    end
    if Hardware::CPU.intel?
      url "https://github.com/shieldmark-io/homebrew-craguard/releases/download/v0.6.5/craguard-0.6.5-linux-x64.tar.gz"
